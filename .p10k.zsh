# Generated by Powerlevel10k configuration wizard on 2020-03-04 at 21:32 CST.
...
# time, 2 lines, sparse, instant_prompt=verbose.
...
prompt_zsh_battery_level() {
  ...
  echo -n "%{$color%} $percentage%% ($remaining)" ;
}
...
() {
  ...
  if [[ "$OSTYPE" == *"darwin"* ]]; then
    POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS+=(custom_battery_status)
  else
